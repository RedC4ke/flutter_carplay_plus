...
struct WrappedTemplateData {
    ...
    func toList() -> [Any?] {
        return [
            self.type.rawValue,
            self.data.toList(),
            self.listTemplateData?.toList(),
            self.tabBarTemplateData?.toList(),
        ]
    }
}
...
struct FCPListTemplateData {
    ...
    func toList() -> [Any?] {
        return [
            self.barButtonProvidingData?.toList(),
            self.sections,
...
struct FCPListSectionData {
    ...
    static func fromList(_ list: [Any?]) -> FCPListSectionData? {
        let componentData = FCPComponentData.fromList(list[0] as! [Any?])!
        let header: String? = nilOrValue(list[1])
        let sectionIndexTitle: String? = nilOrValue(list[2])
        let items = list[3] as! [WrappedListItemData?]
        var headerButton: FCPButtonData?
        if let headerButtonList: [Any?] = nilOrValue(list[4]) {
            headerButton = FCPButtonData.fromList(headerButtonList)
        }
        var headerImage: FCPImageData?
        if let headerImageList: [Any?] = nilOrValue(list[5]) {
            headerImage = FCPImageData.fromList(headerImageList)
        }
        let headerSubtitle: String? = nilOrValue(list[6])
    ...
    func toList() -> [Any?] {
        return [
            ...
            self.items,
            self.headerButton?.toList(),
            self.headerImage?.toList(),
            self.headerSubtitle,
        ]
    }
}
...
struct FCPListItemData {
    ...
    static func fromList(_ list: [Any?]) -> FCPListItemData? {
        ...
        var accessoryImage: FCPImageData?
    ...
    func toList() -> [Any?] {
        return [
            self.accessoryType.rawValue,
            self.accessoryImage?.toList(),
            self.detailText,
            self.image?.toList(),
            self.isExplicitContent,
            self.isPlaying,
            self.playingIndicatorLocation.rawValue,
...
struct FCPMessageListItemLeadingConfigurationData {
    ...
    static func fromList(_ list: [Any?]) -> FCPMessageListItemLeadingConfigurationData? {
        var leadingItem: FCPMessageLeadingItem?
    ...
    func toList() -> [Any?] {
        return [
            self.leadingItem?.rawValue,
            self.leadingImage?.toList(),
            self.isUnread,
        ]
    }
}
...
struct FCPMessageListItemTrailingConfigurationData {
    ...
    static func fromList(_ list: [Any?]) -> FCPMessageListItemTrailingConfigurationData? {
        ...
        var trailingImage: FCPImageData?
    ...
    func toList() -> [Any?] {
        return [
            self.trailingItem.rawValue,
            self.trailingImage?.toList(),
        ]
    }
}
...
struct FCPListMessageItemData {
    ...
    static func fromList(_ list: [Any?]) -> FCPListMessageItemData? {
        ...
        var leadingConfiguration: FCPMessageListItemLeadingConfigurationData?
        ...
        var trailingConfiguration: FCPMessageListItemTrailingConfigurationData?
    ...
    func toList() -> [Any?] {
        return [
            ...
            self.phoneOrEmailAddress,
            self.detailText,
            self.trailingText,
            self.leadingConfiguration?.toList(),
            self.trailingConfiguration?.toList(),
        ]
    }
}
...
struct WrappedListItemData {
    ...
    func toList() -> [Any?] {
        return [
            self.type.rawValue,
            self.itemData.toList(),
            self.listItemData?.toList(),
            self.imageRowItemData?.toList(),
            self.messageItemData?.toList(),
        ]
    }
}
...
struct FCPBarButtonProvidingData {
    ...
    static func fromList(_ list: [Any?]) -> FCPBarButtonProvidingData? {
        var backButtonData: FCPBarButtonData?
    ...
    func toList() -> [Any?] {
        return [
            self.backButtonData?.toList(),
            self.leadingNavigationBarButtonsData,
            self.trailingNavigationBarButtonsData,
        ]
    }
}
...
class TemplateFlutterApi: TemplateFlutterApiProtocol {
    ...
    func interactionStarted(objectId objectIdArg: String, completion: @escaping (Result<Void, FlutterError>) -> Void) {
        let channelName = "dev.flutter.pigeon.flutter_carplay_plus.TemplateFlutterApi.interactionStarted"
    ...
    func onTabSelected(tabBarTemplateId tabBarTemplateIdArg: String, selectedTemplateId selectedTemplateIdArg: String, completion: @escaping (Result<Void, FlutterError>) -> Void) {
        let channelName = "dev.flutter.pigeon.flutter_carplay_plus.TemplateFlutterApi.onTabSelected"
        let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger)
